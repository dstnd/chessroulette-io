...
//     expect(mapperErrorSpy).toBeCalledTimes(0);
//   });
//   test('reconciles multiple paths and gets the correct type inside flatMaps body', async () => {
//     const r = new AsyncOk(2);
//     const mapperSpy = jest.fn();
//     // r.flatMap((v): AsyncResult<boolean, string> => {
//     r.flatMap((v): AsyncResult<boolean, string> => {
//       // This never goes above 1 so it will always return true.
//       // That's ok b/c we only need to check the compile time types
//       //  not the runtime values
//       if (Math.random() < 1) {
//         return new AsyncOk(true);
//       }
//       return new AsyncErr('Oops');
//     })
//     // .flatMap((s) => )
//     .map((v) => {
//       isExactType<typeof v, boolean>(true);
//       mapperSpy(v);
//     });
//     await delay();
//     expect(mapperSpy).toBeCalledWith(true)
//     // r.map((s) => s.)/
//   });
//   test('reconciles multiple paths and gets the correct type inside fmap body', async () => {
//     const r = new AsyncOk(2);
//     const mapperSpy = jest.fn();
//     r.flatMap((v): AsyncResult<boolean, string> => {
//     // r.fmap((v) => {
...
// });
// describe('Resolve', () => {
//   test('AsyncOk returns Ok Result', async () => {
//     const asyncRes = new AsyncOk(2);
//     const res = await asyncRes.resolve();
//     expect(res.ok).toBe(true);
//     expect(res.val).toBe(2);
//     if (res.ok) {
//       isExactType<typeof res.val, number>(true);
//     } else {
//       throw new Error('Ok should be true!');
//     }
//   });
//   test('AsyncOk returns Err Result', async () => {
//     const asyncRes = new AsyncErr('SimpleError');
//     const res = await asyncRes.resolve();
//     expect(res.ok).toBe(false);
//     expect(res.val).toBe('SimpleError');
//     isExactType<typeof res.val, string>(true);
//   });
//   test('resolve can be called after a map', async () => {
//     const asyncRes = new AsyncOk(2).map((v) => v + 4);
//     const res = await asyncRes.resolve();
//     expect(res.ok).toBe(true);
...
//     }
//   });
//   test('resolve can be called after multiple maps', async () => {
//     const asyncRes = new AsyncOk(2).map((v) => v + 4);
//     const res = await asyncRes.map((v) => v - 2).map((v) => v * 10).resolve();
//     expect(res.ok).toBe(true);
//     expect(res.val).toBe(40);
//     if (res.ok) {
//       isExactType<typeof res.val, number>(true);
//     } else {
//       throw new Error('Ok should be true!');
//     }
//   });
//   test('resolve can be called after a mapErr', async () => {
//     const asyncRes = new AsyncErr('SimpleErr')
//       .mapErr((v) => v + 2)
//       .mapErr((v) => v + 3);
//     const res = await asyncRes.resolve();
//     expect(res.ok).toBe(false);
//     expect(res.val).toBe('SimpleErr23');
//     isExactType<typeof res.val, string>(true);
//   });
//   test('resolve can be called after a flatMap', async () => {
//     const asyncRes = new AsyncOk(2)
//       .flatMap((v) => new AsyncOk(v + 10))
//       .map((v) => v + 4);
//     const res = await asyncRes.resolve();
//     expect(res.ok).toBe(true);
//     expect(res.val).toBe(16);
//   });
//   test('resolve can be called after multiple flatMaps', async () => {
//     const asyncRes = new AsyncOk(2)
//       .flatMap((v) => new AsyncOk(v + 10))
//       .flatMap((v) => new AsyncOk(v + 10))
//       .flatMap((v) => new AsyncOk(v + 10));
...
//   });
// });
//# sourceMappingURL=asyncResult.test2.js.map