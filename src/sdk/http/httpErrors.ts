...
export const httpGenericError = () => io.type({
...
export const httpCustomError = <T extends io.Mixed>(content: T) => io.type({
...
export const httpCustomTypeErrorFromProps = <T extends io.Props>(content: T) => httpCustomError(io.type(content));


export type HttpErrorCodec = HttpGenericErrorCodec | HttpCustomErrorCodec | HttpInputValidationErrorCodec;
